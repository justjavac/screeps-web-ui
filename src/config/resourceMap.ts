const resourceMap: Record<string, string> = {
  ...
  "deposit-biomass": "deposit-biomass.svg",
  "deposit-biomass-fill": "deposit-biomass-fill.svg",
  "deposit-metal": "deposit-metal.svg",
  "deposit-metal-fill": "deposit-metal-fill.svg",
  "deposit-mist": "deposit-mist.svg",
  "deposit-mist-fill": "deposit-mist-fill.svg",
  "deposit-silicon": "deposit-silicon.svg",
  "deposit-silicon-fill": "deposit-silicon-fill.svg",
  disable: "disable.svg",
  ...
  exhaust: "exhaust.svg",
  "regenerate-mineral": "regen-mineral.svg",
  "regenerate-source": "regen-source.svg",
  factory: "factory.svg",
  "factory-lvl0": "factory-lvl0.svg",
  "factory-lvl1": "factory-lvl1.svg",
  "factory-lvl2": "factory-lvl2.svg",
  "factory-lvl3": "factory-lvl3.svg",
  "factory-lvl4": "factory-lvl4.svg",
  "factory-lvl5": "factory-lvl5.svg",
  "factory-border": "factory-border.svg",
  "factory-highlight": "factory-highlight.svg",
  flag: "flag.svg",
...
for (const k in resourceMap) {
  resourceMap[k] = `https://screeps.devtips.cn/metadata/${resourceMap[k]}`;
}

const rescaleResources: string[] = [
  "bodyPartBar",
  "controller",
  "controller-level",
  "constructedWall",
...
export { rescaleResources, resourceMap };
