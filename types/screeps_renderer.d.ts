...
declare module "@screeps/renderer" {
  ...
  export class GameRenderer {
    ...
    static compileMetadata(metadata: any): void;
    ...
    applyState(state: Partial<State>, tickDuration: number): void;
  ...
  export interface ProcessorMetadata<T extends ProcessorPayload>
    extends RunnableMetadata {
    type: string;
    id: string;
    payload?: T;
  ...
  export type GameMetrics = Metrics & { fps: number };

  export class ActionManager {
    constructor();
    update(delta: number): void;
    runAction(container: Container, action: Action): ActionHandle;
    cancelAction(actionHandle: ActionHandle);
    void;
    finishAction(actionHandle: ActionHandle);
    void;
    cancelActionForContainer(container: Container);
    void;
  }
